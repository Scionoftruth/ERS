...
let retreiveAllReimbursements = async () => {
	let res = await fetch(`http://localhost:8080/ERS/api/getAllReimbursements`);
	let obj = await res.json();
	return obj;
}
...
let retreiveAllApprovedReimbursements = async () => {
	let res = await fetch(`http://localhost:8080/ERS/api/getAllAccepted`);
	let obj = await res.json();
	return obj;
}

let retreiveAllDeniedReimbursements = async () => {
	let res = await fetch(`http://localhost:8080/ERS/api/getAllDenied`);
	let obj = await res.json();
	return obj;
}
